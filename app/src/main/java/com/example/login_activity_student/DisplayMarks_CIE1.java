...
public class DisplayMarks_CIE1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_display_marks_cie1);

        Stud_usn = (TextView) findViewById(R.id.student_USN);
        recyclerView =(RecyclerView) findViewById(R.id.recycler_view);
        recyclerView.setLayoutManager(new LinearLayoutManager(DisplayMarks_CIE1.this));
        marksList = new ArrayList<>();
        adapter = new marks_adapter(marksList);
        recyclerView.setAdapter(adapter);

        FirebaseDatabase database = FirebaseDatabase.getInstance();
        DatabaseReference marksRef = database.getInstance().getReference("Marks").child("CIE-1");
    ...
    public void onBackPressed() {
        Intent intent = new Intent(DisplayMarks_CIE1.this,CIE_Display_Decider.class);
