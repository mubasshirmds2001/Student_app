...
public class Marks_CIE3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_marks_cie3);
        ...
        spinner = (Spinner)findViewById(R.id.spinner_usn3);
        // Retrieve the array resource from strings.xml
        String[] usnlst = getResources().getStringArray(R.array.usn_list);

        ArrayAdapter<String> adapter = new ArrayAdapter<>(Marks_CIE3.this, android.R.layout.simple_spinner_item, usnlst);
        ...
        mAddMarks.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatabaseReference marksRef = database.getReference("Marks").child("CIE-3");
                ...
                query.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if (dataSnapshot.exists()) {
                            ...
                            Toast.makeText(Marks_CIE3.this, "Marks for the selected USN already exists", Toast.LENGTH_SHORT).show();
                        } else {
                            ...
                            if (TextUtils.isEmpty(studentUSN) || TextUtils.isEmpty(subject1Marks) || TextUtils.isEmpty(subject2Marks) || TextUtils.isEmpty(subject3Marks) ||
                                ...
                                Toast.makeText(Marks_CIE3.this, "Please enter marks for all subjects", Toast.LENGTH_SHORT).show();
                                return;
                            }
                            ...
                            if (marks1 < 0 || marks1 > 50 || marks2 < 0 || marks2 > 50 ||
                                ...
                                Toast.makeText(Marks_CIE3.this, "Marks should be between 0 and 50 for all subjects", Toast.LENGTH_SHORT).show();
                                return;
                            } else if (marks3 < 0 || marks3 > 100 || marks5 < 0 || marks5 > 100) {
                                Toast.makeText(Marks_CIE3.this, "Marks should be between 0 and 100 for Lab subjects", Toast.LENGTH_SHORT).show();
                                return;
                            }
                            ...
                            marksRef.child(marksId).setValue(marks)
                                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                                        ...
                                        public void onSuccess(Void aVoid) {
                                            ...
                                            Toast.makeText(Marks_CIE3.this, "Marks added successfully", Toast.LENGTH_SHORT).show();
                                    ...
                                    .addOnFailureListener(new OnFailureListener() {
                                        ...
                                        public void onFailure(@NonNull Exception e) {
                                            ...
                                            Toast.makeText(Marks_CIE3.this, "Failed to add marks", Toast.LENGTH_SHORT).show();
                                        }
                                    });
                        }
                    }
                    ...
                    public void onCancelled(@NonNull DatabaseError databaseError) {
                        ...
                        Toast.makeText(Marks_CIE3.this, "Database error: " + databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
    ...
    public void onBackPressed() {
        Intent intent = new Intent(Marks_CIE3.this, CIE_decider.class);
